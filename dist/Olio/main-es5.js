      ...
      var MenuComponent = /*#__PURE__*/function () {
        function MenuComponent(router, route, db, _bottomSheet) {
          ...
          db.collection('hotels').doc(this.hotel_name).valueChanges().subscribe(function (val) {
            _this5.categories = val.categoriesData;
          });
        }
